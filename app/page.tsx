...
export default function Home() {
  ...
  return (
    <main className="app-shell">
      ...
      {modal === "documents" && <Overlay title="Lokale Reisedokumente" eyebrow="IPHONE-KURZBEFEHLE" onClose={() => setModal(null)}><div className="privacy-banner"><span>✓</span><div><b>Keine Datei wird hochgeladen</b><small>Die App startet nur einen Kurzbefehl auf diesem iPhone. Dokumente bleiben in „Dateien“ und gehören nicht zum App- oder GitHub-Code.</small></div></div><div className="document-launchers"><a href="shortcuts://run-shortcut?name=Personalausweis"><span>▣</span><b>Personalausweis<small>Kurzbefehl „Personalausweis“ starten</small></b><em>Öffnen</em></a><a href="shortcuts://run-shortcut?name=Auslandsreiseversicherung"><span>✚</span><b>Auslandsreiseversicherung<small>Kurzbefehl „Auslandsreiseversicherung“ starten</small></b><em>Öffnen</em></a></div><div className="shortcut-setup"><p className="eyebrow">EINMAL AUF JEDEM IPHONE EINRICHTEN</p><ol><li>Beide Dokumente geschützt in der Apple-App „Dateien“ ablegen.</li><li>In „Kurzbefehle“ jeweils einen neuen Kurzbefehl anlegen.</li><li>Die Namen exakt als <b>Personalausweis</b> und <b>Auslandsreiseversicherung</b> speichern.</li><li>Im jeweiligen Kurzbefehl die passende Datei auswählen und mit „Übersicht“/Quick Look anzeigen lassen.</li><li>Einmal in der Kurzbefehle-App testen; danach funktionieren die Buttons hier.</li></ol><div className="shortcut-actions"><a href="shortcuts://create-shortcut">Neuen Kurzbefehl anlegen</a><a href="shortcuts://">Kurzbefehle öffnen</a></div></div><p className="small-note">Falls iOS beim ersten Start nach Zugriff auf „Dateien“ fragt, muss dieser einmal lokal bestätigt werden. Die Bezeichnungen der Aktionen können je nach iOS-Sprache leicht abweichen.</p></Overlay>}
